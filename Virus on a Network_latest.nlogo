...
to create-links
 file-open "edges.txt"
 repeat 16 [
    ask turtle file-read [ create-link-with turtle file-read ]]
...
to do-virus-checks-random
  if virus-firefighter < number-of-firefighter[
    set virus-firefighter virus-firefighter + 1
